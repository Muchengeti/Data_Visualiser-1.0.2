...
module SwaggerClient
  ...
  class CollectionUpdate
    ...
    def hash
      [title, description, articles, authors, categories, tags, keywords, references, custom_fields, doi, resource_id, resource_doi, resource_link, resource_title, resource_version, group_id].hash
    end
