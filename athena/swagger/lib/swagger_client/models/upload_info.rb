...
module SwaggerClient
  ...
  class UploadInfo
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["PENDING", "COMPLETED", "ABORTED"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["PENDING", "COMPLETED", "ABORTED"])
    ...
    def hash
      [token, md5, size, name, status, parts].hash
    end
