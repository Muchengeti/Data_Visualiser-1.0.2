...
# Unit tests for SwaggerClient::CommonSearch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonSearch' do
  before do
    # run before each test
    @instance = SwaggerClient::CommonSearch.new
  end
  ...
  describe 'test an instance of CommonSearch' do
    it 'should create an instance of CommonSearch' do
      expect(@instance).to be_instance_of(SwaggerClient::CommonSearch)
    end
  end
