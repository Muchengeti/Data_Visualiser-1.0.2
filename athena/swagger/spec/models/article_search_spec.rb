...
# Unit tests for SwaggerClient::ArticleSearch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArticleSearch' do
  before do
    # run before each test
    @instance = SwaggerClient::ArticleSearch.new
  end
  ...
  describe 'test an instance of ArticleSearch' do
    it 'should create an instance of ArticleSearch' do
      expect(@instance).to be_instance_of(SwaggerClient::ArticleSearch)
    end
  end
